...
Versão: 6.0 - Tudo automático, sem .bat, sem .exe
"""
...
# ============================================
# PARTE 1: ATIVA O .VENV SOZINHO
# ============================================

def ativar_venv_auto():
    """Ativa o .venv automaticamente - SEM .bat, SEM .exe"""
    ...
    # Reinicia com o Python do .venv
    print("🔄 Reiniciando no .venv...")
    os.execv(python_venv, [python_venv] + sys.argv)
    return True

# Executa a ativação
if not ativar_venv_auto():
    print("❌ Erro ao ativar .venv")
    sys.exit(1)

# ============================================
# PARTE 2: INSTALA AS DEPENDÊNCIAS SOZINHO
# ============================================
...
def instalar_dependencias():
    ...
    # Reinicia para carregar as novas bibliotecas
    print("🔄 Reiniciando com as novas bibliotecas...")
...
# ============================================
# PARTE 3: IMPORTA AS BIBLIOTECAS E RODA
# ============================================
...
# Agora as bibliotecas já estão instaladas
...
print("🚀 Iniciando Cleanup Manager...")
